...
const createButton = () => {
  ...
  `
    ...
    korea.addEventListener("click", listKoreaMenu);
    japan.addEventListener("click", listJapanMenu);
    china.addEventListener("click", listChinaMenu);
